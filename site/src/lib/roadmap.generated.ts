...
export const generatedBlocks: GeneratedBlock[] = [
  ...
  { block: "I", title: "Voxel models from a declaration", open: 8 },
...
export const generatedTasks: GeneratedTask[] = [
  ...
  },
  {
    id: "PW96",
    block: "I",
    symptom: "a symmetric shape must be declared whole, so its two halves can drift apart",
    why: "Ships and most enemies are mirror-symmetric, and declaring one half halves the work and makes asymmetry impossible by construction.",
    deps: [],
  },
  {
    id: "PW97",
  ...
  },
  {
    id: "PW101",
    block: "I",
    symptom: "building a declaration takes a Python script of the project's own",
    why: "Every consumer writes the same few lines to build, write and preview, and a project written in GDScript has no natural place to keep them.",
    deps: [],
  },
  {
    id: "PW102",

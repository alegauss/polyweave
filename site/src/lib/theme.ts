...
// reading the effective theme and flipping it. The token that the body background reads is
// keyed off the data-theme attribute, so setting the attribute is the whole act.
